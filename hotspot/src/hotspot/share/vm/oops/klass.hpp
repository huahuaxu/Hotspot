...
class Klass : public Klass_vtbl {
 ...
 protected:
  ...
  jint        _layout_helper;	//该类型的实例对象所占用的内存空间大小
  ...
  Symbol*     _name;	//该类型的符号应用，表示该类的全限定名
 ...
 protected:
  ...
  AccessFlags _access_flags;    // 类型的访问标志
 ...
 public:
  ...
  static jint instance_layout_helper(jint size, bool slow_path_flag) {
    return (size << LogHeapWordSize) |    (slow_path_flag ? _lh_instance_slow_path_bit : 0);
  }
