...
//int及其对应数组类型的java.lang.Class对象
oop Universe::_int_mirror                             = NULL;
//float及其对应数组类型的java.lang.Class对象
oop Universe::_float_mirror                           = NULL;
//double及其对应数组类型的java.lang.Class对象
oop Universe::_double_mirror                          = NULL;
//byte及其对应数组类型的java.lang.Class对象
oop Universe::_byte_mirror                            = NULL;
//boolean及其对应数组类型的java.lang.Class对象
oop Universe::_bool_mirror                            = NULL;
//int及其对应数组类型的java.lang.Class对象
oop Universe::_char_mirror                            = NULL;
//long及其对应数组类型的java.lang.Class对象
oop Universe::_long_mirror                            = NULL;
//short及其对应数组类型的java.lang.Class对象
oop Universe::_short_mirror                           = NULL;
//void及其对应数组类型的java.lang.Class对象
...
/**
 * 创建基本类型(int/float/double/byte/bool/char/long/short/void)及其对应数组类型的java.lang.Class对象
 */
...
jint universe_init() {
  ...
  printf("%s[%d] [tid: %lu]: 开始试图获取GC锁...\n", __FILE__, __LINE__, pthread_self());
  GC_locker::lock();  // do not allow gc during bootstrapping

  //计算核心类的属性在其对象实例中的偏移位置
  ...
  if (UseSharedSpaces) {
	...
	printf("%s[%d] [tid: %lu]: 创建一个FileMapInfo.\n", __FILE__, __LINE__, pthread_self());
...
char* Universe::preferred_heap_base(size_t heap_size, NARROW_OOP_MODE mode) {
  ...
  if (UseCompressedOops) {	//使用压缩指针的方式

    assert(mode == UnscaledNarrowOop  ||
           mode == ZeroBasedNarrowOop || mode == HeapBasedNarrowOop, "mode is invalid");
