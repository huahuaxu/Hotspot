...
// Use the following at your own risk
 ...
 protected:                         // protected for jvmtiRawMonitor
  void *  volatile _owner;          // 对象锁的拥有者(线程)
  volatile intptr_t  _recursions;   // 对象锁的拥有者重复持有的次数
 private:
  int OwnerIsThread ;               // _owner is (Thread *) vs SP/BasicLock
  ObjectWaiter * volatile _cxq ;    // 等待对象锁的线程队列
                                    // The list is actually composed of WaitNodes, acting
                                    // as proxies for Threads.
 protected:
  ObjectWaiter * volatile _EntryList ;     //可以唤醒的线程队列
 private:
  ...
  volatile intptr_t  _count;        //当前竞争该对象锁的线程数量
 ...
 private:
 protected:
  ObjectWaiter * volatile _WaitSet; //等待被唤醒的线程队列
 private:
