...
AdjoiningGenerations::AdjoiningGenerations(ReservedSpace old_young_rs,
  ...
  // move the boundary.
  if (UseAdaptiveGCBoundary) {	//新生代和旧生代大小可调整
    ...
    printf("%s[%d] [tid: %lu]: 试图创建年青代[ASPSYoungGen]: 初始大小(bytes)=%lu, 最小大小(bytes)=%lu, 最大大小(bytes)=%lu ...\n",
        		__FILE__, __LINE__, pthread_self(), _virtual_spaces.high()->committed_size(), min_high_byte_size, _virtual_spaces.high_byte_size_limit());
    ...
    printf("%s[%d] [tid: %lu]: 试图创建老年代[ASPSOldGen]: 初始大小(bytes)=%lu, 最小大小(bytes)=%lu, 最大大小(bytes)=%lu ...\n",
        		__FILE__, __LINE__, pthread_self(), _virtual_spaces.low()->committed_size(), min_low_byte_size, _virtual_spaces.low_byte_size_limit());
    ...
    printf("%s[%d] [tid: %lu]: 试图创建年青代[PSYoungGen]: 初始大小(bytes)=%lu, 最小大小(bytes)=%lu, 最大大小(bytes)=%lu ...\n",
    		__FILE__, __LINE__, pthread_self(), init_high_byte_size, min_high_byte_size, max_high_byte_size);
    _young_gen = new PSYoungGen(init_high_byte_size, min_high_byte_size, max_high_byte_size);

    printf("%s[%d] [tid: %lu]: 试图创建老年代[PSOldGen]: 初始大小(bytes)=%lu, 最小大小(bytes)=%lu, 最大大小(bytes)=%lu ...\n",
    		__FILE__, __LINE__, pthread_self(), init_low_byte_size, min_low_byte_size, max_low_byte_size);
