...
class ParallelScavengeHeap : public CollectedHeap {
 ...
 private:
  static PSYoungGen* _young_gen;	//可并行回收的年青代内存管理器
  static PSOldGen*   _old_gen;	//可并行回收的旧生代内存管理器
  static PSPermGen*  _perm_gen;	//可并行回收的持久代内存管理器
  ...
  AdjoiningGenerations* _gens; //邻近的内存代管理器
