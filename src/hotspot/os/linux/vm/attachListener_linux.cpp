...
int LinuxAttachListener::init() {
  ...
  printf("%s[%d] [tid: %lu]: 开始初始化LinuxAttachListener...\n", __FILE__, __LINE__, pthread_self());
  ...
  printf("%s[%d] [tid: %lu]: 开始监听套接字[PF_UNIX: %s]...\n", __FILE__, __LINE__, pthread_self(), initial_path);
...
/**
 * 接收一个外部命令,被"Attach Listener"线程调用
 */
