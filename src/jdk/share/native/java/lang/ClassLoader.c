...
{
	printf("%s[%d] [tid: %lu]: 开始执行本地方法[java.lang.ClassLoader.registerNatives]..\n", __FILE__, __LINE__, pthread_self());
...
Java_java_lang_ClassLoader_defineClass0(JNIEnv *env,
                                        ...
                                        jobject pd)
{
	printf("%s[%d] [tid: %lu]: 开始执行本地方法[java.lang.ClassLoader.defineClass0]..\n", __FILE__, __LINE__, pthread_self());
                                        ...
                                        jstring source)
{
    ...
    printf("%s[%d] [tid: %lu]: 开始执行本地方法[java.lang.ClassLoader.defineClass1]..\n", __FILE__, __LINE__, pthread_self());
                                        ...
                                        jstring source)
{
    ...
    printf("%s[%d] [tid: %lu]: 开始执行本地方法[java.lang.ClassLoader.defineClass2]..\n", __FILE__, __LINE__, pthread_self());
...
Java_java_lang_ClassLoader_resolveClass0(JNIEnv *env, jobject this,
                                         jclass cls)
{
	printf("%s[%d] [tid: %lu]: 开始执行本地方法[java.lang.ClassLoader.resolveClass0]..\n", __FILE__, __LINE__, pthread_self());
                                              ...
                                              jstring classname)
{
    ...
    printf("%s[%d] [tid: %lu]: 开始执行本地方法[java.lang.ClassLoader.findBootstrapClass]..\n", __FILE__, __LINE__, pthread_self());
...
Java_java_lang_ClassLoader_findLoadedClass0(JNIEnv *env, jobject loader,
                                           jstring name)
{
	printf("%s[%d] [tid: %lu]: 开始执行本地方法[java.lang.ClassLoader.findLoadedClass0]..\n", __FILE__, __LINE__, pthread_self());
